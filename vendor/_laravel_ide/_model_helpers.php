...
namespace Webkul\Security\Models {
    ...
    /**
     * Webkul\Security\Models\User
     *
     * @property mixed $partner_id
     * @property integer|null $default_company_id
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon|null $deleted_at
     * @property string|null $remember_token
     * @property mixed $resource_permission
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Security\Models\Team> $teams
     * @property-read int|null $teams_count
     * @property-read \Webkul\Employee\Models\Employee $employee
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Employee\Models\Department> $departments
     * @property-read int|null $departments_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Support\Models\Company> $companies
     * @property-read int|null $companies_count
     * @property-read \Webkul\Partner\Models\Partner $partner
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Support\Models\Company> $allowedCompanies
     * @property-read int|null $allowedCompanies_count
     * @property-read \Webkul\Support\Models\Company $defaultCompany
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereResourcePermission($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereDefaultCompanyId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User wherePartnerId($value)
...
namespace App\Models {
     ...
     *
     * @property mixed $partner_id
     * @property mixed $default_company_id
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
...
namespace Webkul\Support\Models {
     ...
     * @property string $name
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Support\Models\Plugin> $dependencies
     * @property-read int|null $dependencies_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Webkul\Support\Models\Plugin> $dependents
     * @property-read int|null $dependents_count
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereAuthor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereSummary($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereLatestVersion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereLicense($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereIsActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereIsInstalled($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereSort($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin ordered()
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Plugin>|Plugin query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
...
namespace Webkul\Website\Models {
     ...
     * @property boolean $is_footer_visible
     * @property boolean $is_header_visible
     * @property boolean $is_published
     * @property string $slug
     * @property string $content
     * @property string $title
     * @property int $id
     * @property-read \Webkul\Security\Models\User $creator
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Page>|Page whereIsHeaderVisible($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Page>|Page whereIsFooterVisible($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Page>|Page whereCreatorId($value)
